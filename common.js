...
function extendWeapon(extensions, weapon)
{
    for(extension of extensions){
        if(extension.startsWith("#")){
            ...
            customExtension(weapon, extension);
        }
    }
}
...
function getExtendedValue(weapon, extension){
    if(extension.startsWith("#")){
        ...
        return customExtension(weapon, extension);
	}
...
function getShipStat(ship, loadout, weaponData, stat){
    ...
    switch(stat){
        ...
        case "autopilotSpeed":
            ...
            break;
        case "autopilotBoostSpeed":
            val = getShipStat(ship, loadout, weaponData, "boostAverageSpeed") + engine.autoPilotSpeedInc;
            break;
